...
class Solution1(object):  # naive solution, 80% pass rate
...
class Solution2(object):  # minimax, worst case: 10 guesses
    def findSecretWord(self, wordlist, master):
        """
        :type wordlist: List[Str]
        :type master: Master
        ...
        while matches < 6:
            ...
            matches = master.guess(guess)
            wordlist = [w for w in wordlist if self.match(w, guess) == matches]
